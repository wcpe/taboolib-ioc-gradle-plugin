        ...
        return linkedMapOf(
            ...
            "injectionPointIndex" to injectionPointIndex.map { injection ->
                linkedMapOf(
                    ...
                    "sourceLine" to injection.sourceLine,
                    "sourceColumn" to injection.sourceColumn,
            ...
            "diagnostics" to diagnostics.map { diagnostic ->
                linkedMapOf(
                    ...
                    "sourceFile" to diagnostic.sourceFile,
                    "sourcePath" to diagnostic.sourcePath,
                    "sourceLine" to diagnostic.sourceLine,
                    "sourceColumn" to diagnostic.sourceColumn,
                    "kind" to diagnostic.injectionPointKind.name.lowercase(),
                    "parameterIndex" to diagnostic.parameterIndex,
